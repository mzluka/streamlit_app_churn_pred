...
def main():
    ...
    сравнение качества полученных моделей, развёртывание в StreamLit Cloud. В итоге, выявлена модель с наибольшей предиктивной мощностью (f1-score=0,90) на основе алгоритма машинного обучения LigthGBM
